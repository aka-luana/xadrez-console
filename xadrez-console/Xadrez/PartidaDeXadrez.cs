...
namespace Xadrez
{
    class PartidaDeXadrez
    {
        ...
        public Peca VulneralvelEnPasseant { get; private set; }
        ...
        public void DesafazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if (p is Peao)
            {
                if (origem.Coluna != destino.Coluna && pecaCapturada == VulneralvelEnPasseant)
                {
